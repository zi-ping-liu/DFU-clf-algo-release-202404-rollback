...
class Config():
    ...
    def __init__(self,
        ...
        #########################################################################
        #                            TRAINING DETAIL
        self.EXPORT_PATH = "/home/efs/ziping/workspaces/dfu/clf_algo_release_202404_rollback/results/reproduce_BSV/" + self.MODEL.strip().lower()
...
if __name__ == "__main__":
    ...
    gs_df = pd.read_csv("/home/efs/ziping/workspaces/dfu/clf_algo_release_202404_rollback/src/data/grid_search_012624.csv")
    ...
    train_csv = "/home/efs/ziping/workspaces/dfu/clf_algo_release_202404_rollback/src/data/processed_WAUSI_BSV_20240306.csv"
