...
class Config():
    ...
    def __init__(self,
        ...
        #########################################################################
        #                            TRAINING DETAIL
        self.EXPORT_PATH = f"/home/efs/ziping/workspaces/dfu/clf_algo_release_202404_rollback/results/shiftwin_v2/random_split_{split}/" + self.MODEL.strip().lower()
...
if __name__ == "__main__":
    ...
    gs_df = pd.read_csv("/home/efs/ziping/workspaces/dfu/clf_algo_release_202404_rollback/src/data/grid_search_baseline_240419.csv")
    ...
    train_csv = f"/home/efs/ziping/workspaces/dfu/clf_algo_release_202404_rollback/src/data/WAUSI_unifiedv6_BSV+slidingwindow_reverted_randsplit_{split}_20240430.csv"
    ...
    train_msi = f"/home/efs/TrainingData/DFU/BSV+slidingwindow_Processed_V4_centercrop_20240422/cropped_msi_ulcer_only/morph_{image_preprocess['MASK_DILATION']}"
