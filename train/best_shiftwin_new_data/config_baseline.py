...
class Config():
    ...
    def __init__(self,
        ...
        #########################################################################
        #                            TRAINING DETAIL
        self.EXPORT_PATH = "/home/efs/ziping/workspaces/dfu/clf_algo_release_202404_rollback/results/best_shiftwin_new_data/" + self.MODEL.strip().lower()
...
if __name__ == "__main__":
    ...
    train_csv = "/home/efs/ziping/workspaces/dfu/clf_algo_release_202404_rollback/src/data/WAUSI_unifiedv4_BSV+slidingwindow_reverted_20240422.csv"
