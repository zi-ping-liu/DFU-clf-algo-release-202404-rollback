...
class Config():
    ...
    def __init__(self,
        ...
        #########################################################################
        #                            TRAINING DETAIL
        self.EXPORT_PATH = "/home/efs/ziping/workspaces/dfu/clf_algo_release_202404_rollback/results/shiftwin_v1/" + self.MODEL.strip().lower()
...
if __name__ == "__main__":
    ...
    train_csv = "/home/efs/ziping/workspaces/dfu/clf_algo_release_202404_rollback/src/data/WAUSI_unifiedv5_BSV+slidingwindow_reverted_newsplit_20240422.csv"
