...
class Config():
    ...
    def __init__(self,
        ...
        #########################################################################
        #                            TRAINING DETAIL
        self.EXPORT_PATH = f"/home/efs/ziping/workspaces/dfu/clf_algo_release_202404_rollback/results/shiftwin_v3/random_split_{split}/" + self.MODEL.strip().lower()
...
if __name__ == "__main__":
    ...
    train_csv = f"/home/efs/ziping/workspaces/dfu/clf_algo_release_202404_rollback/src/data/WAUSI_unifiedv7_BSV+slidingwindow_reverted_randsplit_{split}_20240501.csv"
