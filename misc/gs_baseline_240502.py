...
export_path = "/home/efs/ziping/workspaces/dfu/clf_algo_release_202404_rollback/src/data/grid_search_baseline_240502.csv"
            ...
            for encoder_filters in [[16, 32, 64], [16, 32, 64, 128]]:
                ...
                for num_group_norm in [4, 8, 16]:
                    ...
                    for attention_type in [1]:
                        ...
                        for image_preprocess_normalization in ['min_max_global']:
                            
                            for num_conv in [1]:
                            
                                for class_weight in [[1., 1.], [1., 2.], [1., 4.]]:
                                    
                                    for imag_fcn in [[64], [128]]:
